...
import com.vaibhav.gallery.databinding.FragmentSortListDialogListDialogBinding
import com.vaibhav.gallery.datastore.DataStoreManager

class AlbumSortSheet : BottomSheetDialogFragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        val pref=activity?.getSharedPreferences(DataStoreManager.STORE_ALBUM, Context.MODE_PRIVATE)?.edit()
        readOrder()
        check(order)
